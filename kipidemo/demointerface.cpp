...
ImageCollection DemoInterface::currentAlbum()
{
    ...
    return ImageCollection( new MyImageCollection( "Hello collection", list ) );
}

ImageCollection DemoInterface::currentSelection()
{
    return ImageCollection( new MyImageCollection( "Hello collection", KURL::List() ) );
}
...
QValueList<ImageCollection> DemoInterface::allAlbums()
{
    ...
    ImageCollection album1 = ImageCollection( new MyImageCollection( "Album 1", list1 ) );
    ImageCollection album2 = ImageCollection( new MyImageCollection( "Album 1", list2 ) );
