...
#include "regiontaggingwidget.moc"
...
RegionTaggingWidget::~RegionTaggingWidget()
{
    delete d;
}

QRectF RegionTaggingWidget::boundingRect() const
{
    qreal adjust = 0.5;
...
void RegionTaggingWidget::paint(QPainter* /*painter*/, const QStyleOptionGraphicsItem* /*option*/, QWidget* /*widget*/)
{
}

void RegionTaggingWidget::setText(const QString& newName)
{
    d->faceName->setPlainText(newName);
}

QString RegionTaggingWidget::text() const
{
    return d->faceName->toPlainText();
}

void RegionTaggingWidget::update()
{
...
void RegionTaggingWidget::setVisible(bool visible)
{
    d->faceRect->setVisible(visible);
    setControlsVisible(visible);
}

void RegionTaggingWidget::setControlsVisible(bool visible)
{
...
void RegionTaggingWidget::clearText()
{
